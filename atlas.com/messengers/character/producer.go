...
func loginEventProvider(messengerId uint32, worldId world.Id, characterId uint32) model.Provider[[]kafka.Message] {
...
func logoutEventProvider(messengerId uint32, worldId world.Id, characterId uint32) model.Provider[[]kafka.Message] {
	key := producer.CreateKey(int(messengerId))
